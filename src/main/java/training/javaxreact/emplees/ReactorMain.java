...
public class ReactorMain {
    ...
    static void main(String[] args) {
        // Stream.of(new Empleyee("John Doe", 1990), new Empleyee("Jane Smith", 1985)).forEach(System.out::println);
        ...
        Flux.just(new Empleyee("John Doe", 1990), new Empleyee("Jane Smith", 1985))
                ...
                .map(Empleyee::name)
                .singleOrEmpty() // FIXME ATTENTION: here doesn't throw exception if more than one element!!!!!
                .subscribe(System.out::println);

        Flux.just(new Empleyee("John Doe", 1990), new Empleyee("Jane Smith", 1985))
                .map(empleyee -> empleyee.getAge(1987))
                .doOnError(err -> System.out.println(err.getMessage())) // order of the operators matters
                .onErrorReturn(-1)
                .subscribe(System.out::println);
        ...
        Flux.just(new Empleyee("John Doe", 1990), new Empleyee("Jane Smith", 1985))
                ...
                .onErrorReturn(-2)
                .subscribe(System.out::println); // if there is a wrong element, the stream stops at the first error
